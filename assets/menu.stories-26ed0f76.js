var q=Object.defineProperty;var l=(e,t)=>q(e,"name",{value:t,configurable:!0});import{r as C,R as b}from"./index-5837b0d6.js";import{c as _}from"./index-9f7f24f4.js";import{j as n,a as m}from"./jsx-runtime-e0aa43b5.js";import{I as R}from"./icon-038fbd0a.js";import{T}from"./transition-c7f7276e.js";import{a as O}from"./index-e714fffd.js";import"./es.object.get-own-property-descriptor-89e834e9.js";import"./index-55a28f55.js";import"./index-a2f37619.js";import"./index-1e7e3182.js";import"./iframe-e58528e7.js";import"./web.url.constructor-e24ea8fd.js";import"./es.number.is-integer-88489862.js";import"./make-decorator-f93c3fa3.js";const A=C.exports.createContext({index:"0"}),S=l(e=>{const{className:t,mode:s,style:p,children:o,defaultIndex:f,onSelect:i,defaultOpenSubMenus:r}=e,[M,E]=C.exports.useState(f),x=_("v-menu",t,{"menu-vertical":s==="vertical","menu-horizontal":s!=="vertical"}),h={index:M||"0",onSelect:l(c=>{E(c),i&&i(c)},"handleClick"),mode:s,defaultOpenSubMenus:r},v=l(()=>b.Children.map(o,(c,F)=>{const a=c,{displayName:d}=a.type;if(d==="MenuItem"||d==="SubMenu")return b.cloneElement(a,{index:F.toString()});console.error("Warning: Menu has a child which is not a MenuItem component")}),"renderChildren");return n("ul",{className:x,style:p,"data-testid":"test-menu",children:n(A.Provider,{value:h,children:v()})})},"Menu$1");S.defaultProps={defaultIndex:"0",mode:"horizontal",defaultOpenSubMenus:[]};try{S.displayName="Menu",S.__docgenInfo={description:`> 为网站提供导航功能的菜单。支持横向纵向两种模式，支持下拉菜单。
...
//# sourceMappingURL=menu.stories-26ed0f76.js.map
