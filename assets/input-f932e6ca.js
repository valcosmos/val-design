var F=Object.defineProperty;var i=(u,n)=>F(u,"name",{value:n,configurable:!0});import{c as E}from"./index-ed86a6de.js";import{I as m}from"./icon-938a876b.js";import{a as c,j as e}from"./jsx-runtime-69008c6b.js";const r=i(u=>{const{disabled:n,size:l,icon:p,prepend:a,append:t,style:s,...d}=u,o=E("v-input-wrapper",{[`input-size-${l}`]:l,"is-disabled":n,"input-group":a||t,"input-group-append":!!t,"input-group-prepend":!!a});return c("div",{className:o,style:s,children:[a&&e("div",{className:"v-input-group-prepend",children:a}),p&&e("div",{className:"icon-wrapper",children:e(m,{icon:p,title:`title-${p}`})}),e("input",{className:"v-input-inner",disabled:n,...d}),t&&e("div",{className:"v-input-group-append",children:t})]})},"Input");try{r.displayName="Input",r.__docgenInfo={description:`> 一个基础的Input组件封装，可添加图标，前缀或者后缀组合。
...
//# sourceMappingURL=input-f932e6ca.js.map
