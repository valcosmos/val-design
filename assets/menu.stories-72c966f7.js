var q=Object.defineProperty;var l=(e,t)=>q(e,"name",{value:t,configurable:!0});import{r as C,R as b}from"./index-d84d9d3b.js";import{c as _}from"./index-ed86a6de.js";import{j as n,a as m}from"./jsx-runtime-82e0d3de.js";import{I as R}from"./icon-3e8e0c3f.js";import{T}from"./transition-13e58fcd.js";import{a as O}from"./index-e76e6b7a.js";import"./es.object.get-own-property-descriptor-ca06259f.js";import"./index-eb6056e0.js";import"./index-50ee27ec.js";import"./index-67ef4239.js";import"./iframe-cba0f6c3.js";import"./web.url.constructor-5b9de167.js";import"./es.number.is-integer-0eedfe17.js";import"./make-decorator-470a9479.js";const A=C.createContext({index:"0"}),S=l(e=>{const{className:t,mode:s,style:p,children:o,defaultIndex:f,onSelect:i,defaultOpenSubMenus:r}=e,[M,E]=C.useState(f),B=_("v-menu",t,{"menu-vertical":s==="vertical","menu-horizontal":s!=="vertical"}),h={index:M||"0",onSelect:l(c=>{E(c),i&&i(c)},"handleClick"),mode:s,defaultOpenSubMenus:r},x=l(()=>b.Children.map(o,(c,F)=>{const a=c,{displayName:d}=a.type;if(d==="MenuItem"||d==="SubMenu")return b.cloneElement(a,{index:F.toString()});console.error("Warning: Menu has a child which is not a MenuItem component")}),"renderChildren");return n("ul",{className:B,style:p,"data-testid":"test-menu",children:n(A.Provider,{value:h,children:x()})})},"Menu$1");S.defaultProps={defaultIndex:"0",mode:"horizontal",defaultOpenSubMenus:[]};try{S.displayName="Menu",S.__docgenInfo={description:`> 为网站提供导航功能的菜单。支持横向纵向两种模式，支持下拉菜单。
...
//# sourceMappingURL=menu.stories-72c966f7.js.map
