var q=Object.defineProperty;var l=(e,t)=>q(e,"name",{value:t,configurable:!0});import{r as y,j as n,R as b,b as m}from"./jsx-runtime.62764de5.js";import{c as _}from"./index.220dfe0f.js";import{I as R}from"./icon.fe25b1e4.js";import{T}from"./transition.66c8affd.js";import{a as O}from"./index.171c972e.js";import"./iframe.8d9cac8e.js";import"./index.241e153c.js";import"./index.6f8f5b77.js";import"./index.f6e87996.js";import"./make-decorator.9c0707dc.js";const A=y.exports.createContext({index:"0"}),S=l(e=>{const{className:t,mode:s,style:p,children:o,defaultIndex:f,onSelect:i,defaultOpenSubMenus:r}=e,[M,E]=y.exports.useState(f),x=_("v-menu",t,{"menu-vertical":s==="vertical","menu-horizontal":s!=="vertical"}),h={index:M||"0",onSelect:l(c=>{E(c),i&&i(c)},"handleClick"),mode:s,defaultOpenSubMenus:r},v=l(()=>b.Children.map(o,(c,F)=>{const a=c,{displayName:d}=a.type;if(d==="MenuItem"||d==="SubMenu")return b.cloneElement(a,{index:F.toString()});console.error("Warning: Menu has a child which is not a MenuItem component")}),"renderChildren");return n("ul",{className:x,style:p,"data-testid":"test-menu",children:n(A.Provider,{value:h,children:v()})})},"Menu$1");S.defaultProps={defaultIndex:"0",mode:"horizontal",defaultOpenSubMenus:[]};try{S.displayName="Menu",S.__docgenInfo={description:`> \u4E3A\u7F51\u7AD9\u63D0\u4F9B\u5BFC\u822A\u529F\u80FD\u7684\u83DC\u5355\u3002\u652F\u6301\u6A2A\u5411\u7EB5\u5411\u4E24\u79CD\u6A21\u5F0F\uFF0C\u652F\u6301\u4E0B\u62C9\u83DC\u5355\u3002
...
//# sourceMappingURL=menu.stories.2c0af42a.js.map
