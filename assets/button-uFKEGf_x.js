import{j as d}from"./jsx-runtime-vNq4Oc-g.js";import{c as m}from"./index-uebAiod8.js";const a=u=>{const{type:e,disabled:l,size:n,children:t,href:s,className:o,...r}=u,i=m("btn",o,{[`btn-${e}`]:e,[`btn-${n}`]:n,disabled:e==="link"&&l});return e==="link"&&s?d.jsx("a",{className:i,href:s,...r,children:t}):d.jsx("button",{className:i,disabled:l,...r,children:t})};a.defaultProps={disabled:!1,type:"default"};try{a.displayName="Button",a.__docgenInfo={description:`> 一个简单的Button组件，可通过不同的type，选择不同的颜色风格。
...
//# sourceMappingURL=button-uFKEGf_x.js.map
