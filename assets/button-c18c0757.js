var p=Object.defineProperty;var o=(u,e)=>p(u,"name",{value:e,configurable:!0});import{c}from"./index-ed86a6de.js";import{j as d}from"./jsx-runtime-920531fb.js";const n=o(u=>{const{type:e,disabled:a,size:t,children:l,href:s,className:m,...r}=u,i=c("btn",m,{[`btn-${e}`]:e,[`btn-${t}`]:t,disabled:e==="link"&&a});return e==="link"&&s?d("a",{className:i,href:s,...r,children:l}):d("button",{className:i,disabled:a,...r,children:l})},"Button");n.defaultProps={disabled:!1,type:"default"};try{n.displayName="Button",n.__docgenInfo={description:`> 一个简单的Button组件，可通过不同的type，选择不同的颜色风格。
...
//# sourceMappingURL=button-c18c0757.js.map
