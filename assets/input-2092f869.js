var F=Object.defineProperty;var i=(u,n)=>F(u,"name",{value:n,configurable:!0});import{a as E,j as e}from"./jsx-runtime-303a4c05.js";import{c as m}from"./index-ed86a6de.js";import{I as c}from"./icon-08ccc11e.js";const r=i(u=>{const{disabled:n,size:l,icon:p,prepend:a,append:t,style:s,...d}=u,o=m("v-input-wrapper",{[`input-size-${l}`]:l,"is-disabled":n,"input-group":a||t,"input-group-append":!!t,"input-group-prepend":!!a});return E("div",{className:o,style:s,children:[a&&e("div",{className:"v-input-group-prepend",children:a}),p&&e("div",{className:"icon-wrapper",children:e(c,{icon:p,title:`title-${p}`})}),e("input",{className:"v-input-inner",disabled:n,...d}),t&&e("div",{className:"v-input-group-append",children:t})]})},"Input");try{r.displayName="Input",r.__docgenInfo={description:`> 一个基础的Input组件封装，可添加图标，前缀或者后缀组合。
...
//# sourceMappingURL=input-2092f869.js.map
