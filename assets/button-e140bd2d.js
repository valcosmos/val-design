var p=Object.defineProperty;var d=(u,e)=>p(u,"name",{value:e,configurable:!0});import{j as o}from"./jsx-runtime-69008c6b.js";import{c}from"./index-ed86a6de.js";const a=d(u=>{const{type:e,disabled:l,size:n,children:t,href:s,className:m,...r}=u,i=c("btn",m,{[`btn-${e}`]:e,[`btn-${n}`]:n,disabled:e==="link"&&l});return e==="link"&&s?o("a",{className:i,href:s,...r,children:t}):o("button",{className:i,disabled:l,...r,children:t})},"Button");a.defaultProps={disabled:!1,type:"default"};const E=a;try{a.displayName="Button",a.__docgenInfo={description:`> 一个简单的Button组件，可通过不同的type，选择不同的颜色风格。
...
//# sourceMappingURL=button-e140bd2d.js.map
